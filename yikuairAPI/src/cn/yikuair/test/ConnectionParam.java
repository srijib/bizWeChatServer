...
public class ConnectionParam implements Serializable {
    ...
    private String url="jdbc:mysql://127.0.0.1:3306/yikuair?useUnicode=true&autoReconnect=true&characterEncoding=UTF-8"; // 数据库连接URL  
    private String user="root"; // 数据库连接user  
