...
public class Sql implements Serializable{
	...
	public static Connection getConn(){
		try {
			Class.forName("com.mysql.jdbc.Driver");//112.124.18.208
			conn = DriverManager.getConnection("jdbc:mysql://112.124.18.208:3306/mysql?useUnicode=true&autoReconnect=true&characterEncoding=UTF-8","root","");												
		} catch (Exception e) {	
			e.printStackTrace();
		}
		return conn;
